...
#ifndef CRYPTO_SHA0_ALGORITHM_H
#define CRYPTO_SHA0_ALGORITHM_H
...
namespace hash
{
    class Sha0Algorithm : public HashingAlgorithm
    {
    ...
    public:
        [[nodiscard]] Sha0 *calculate(const std::string &message) const override;
    };
}
#endif //CRYPTO_SHA0_ALGORITHM_H
