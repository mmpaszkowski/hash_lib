...
namespace hash
{
    ...
    Sha512_224Hash *Sha512_224::calculate(const std::string &message) const
    {
        ...
        return new Sha512_224Hash{static_cast<uint32_t>(h0 >> 32), static_cast<uint32_t>(h0 & 0xffffffff),
